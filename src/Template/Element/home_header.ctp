              ...
              <span class="hamburger-inner"></span>
                ...
                <a href="<?= SITE_URL ?>" class="navbar-brand <?= $menuItems['Usershome'] ?>">
                    ...
                    <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'dashboard']); ?>"
                       class="navbar-brand <?= $menuItems['Usershome'] ?>">
                        <?php } ?>
                            ...
                            <?php if (!isset($authUser)) { ?>
                                ...
                                <li class="list-inline-item g-mx-4 g-mt-10 ">
                                    <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'login']); ?>"
                                       class="g-color-gray-dark-v2 g-color-primary--hover g-text-underline--none--hover <?= $menuItems['Userslogin'] ?>">Sign
                                        In</a>
                                </li>
                        ...
                        <nav class="navbar navbar-expand-lg p-0">
                            ...
                            <div
                                ...
                                <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                    ...
                                    <?php } else if ($authUser['has_plan'] == 0) { ?>
                                        <li class="nav-item g-mx-20--lg <?= $menuItems['SubscriptionPackagesplans'] ?>">
                                            <a href="<?= $this->Url->build(['controller' => 'SubscriptionPackages', 'action' => 'plans']); ?>"
                                               class="nav-link px-0">Plans</a>
                                        </li>
                            ...
                            <?php if (!isset($authUser)) { ?>
                                <div
                                    class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg <?= $menuItems['Usersregister'] ?>">
                                    <a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15 "
                                       href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'register']); ?>">Join
                                        now</a>
                                </div>
                            <?php } else { ?>
                                <div
                                    class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg <?= $menuItems['Usersdashboard'] ?>">
                                    <a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15 "
