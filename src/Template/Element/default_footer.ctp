        ...
        <div class="col-md-4 g-mb-10 g-mb-0--md">
            <ul class="list-inline text-center text-md-left mb-0">
                ...
                <li class="list-inline-item">
                    <a class="g-color-gray-dark-v6 g-color-lightblue-v3--hover" href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'home']); ?>">Home</a>
                </li>
                <li class="list-inline-item">
                    <span class="g-color-gray-dark-v6">|</span>
                </li>
                <li class="list-inline-item">
                    <a class="g-color-gray-dark-v6 g-color-lightblue-v3--hover" href="<?= $this->Url->build(['controller' => 'Faqs', 'action' => 'index']); ?>">FAQ</a>
                </li>
                <li class="list-inline-item">
                    <span class="g-color-gray-dark-v6">|</span>
                </li>
                <li class="list-inline-item">
                    <a class="g-color-gray-dark-v6 g-color-lightblue-v3--hover" href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'contact']); ?>">Contact Us</a>
                </li>
            </ul>
        </div>
        <!-- End Footer Nav -->
