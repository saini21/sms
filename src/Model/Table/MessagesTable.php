 ...
 * Messages Model
 *
 * @property \App\Model\Table\MessageCategoriesTable|\Cake\ORM\Association\BelongsTo $MessageCategories
 *
...
class MessagesTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['message_category_id'], 'MessageCategories'));
