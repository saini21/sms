...
class SubscriptionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subscription_package_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2018-09-06 03:36:23',
                'modified' => '2018-09-06 03:36:23'
            ],
        ];
        parent::init();
    }
